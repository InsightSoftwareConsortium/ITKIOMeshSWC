...
ITK module for reading meshes from `SWC files <https://swc-specification.readthedocs.io/en/latest/>`_, a human- and machine-readable format for representing neuron morphology.
